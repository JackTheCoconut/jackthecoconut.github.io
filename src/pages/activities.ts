...
const render = (): void => {
  ...
  document.querySelector<HTMLInputElement>("#search")?.addEventListener("input", (e) => { keyword = (e.target as HTMLInputElement).value; render(); });
  document.querySelector<HTMLSelectElement>("#category")?.addEventListener("change", (e) => { category = (e.target as HTMLSelectElement).value; render(); });
  document.querySelector<HTMLSelectElement>("#sort")?.addEventListener("change", (e) => { sort = (e.target as HTMLSelectElement).value; render(); });
};
