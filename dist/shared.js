...
const bindRouteLinks = (root = document) => {
...
window.TravelApp = { activities, getCart, setCart, isLoggedIn, setLoggedIn, addToCart, updateCartQty, cartRows, cartQty, cartTotal, header, footer, money, go, goDetail, bindRouteLinks };
